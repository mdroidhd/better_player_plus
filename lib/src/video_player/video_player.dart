...
class VideoPlayerValue {
  ...
  @override
  String toString() => 'VideoPlayerValue('
      'duration: $duration, '
      'size: $size, '
      'position: $position, '
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  Future<void> _setDataSource(DataSource dataSourceDescription) async {
    ...
    value = VideoPlayerValue(
        duration: null, isLooping: value.isLooping, volume: value.volume);
...
class _VideoProgressIndicatorState extends State<VideoProgressIndicator> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget paddedProgressIndicator =
        Padding(padding: widget.padding, child: progressIndicator);
